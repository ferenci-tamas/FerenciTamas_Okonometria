...
- Ha nem, akkor azt mondjuk, hogy a két változó között _interakció_ van: az egyik marginális hatásának _nagyságát_ befolyásolja a másik _szintje_
...
- Tehát az interakció _szükségképp_, automatikusan "szimmetrikus": ha az egyik változó szintje hat a másik marginális hatására akkor szükségképp fordítva is: a másik szintje is hatni fog az előbbi marginális hatására
...
- (Csak az ESS számításához szükséges $\widehat{Y}$-ok másképp jönnek ki, de ez a fenti optimalizáció szempontjából _teljesen mindegy_)
...
- Ezért nevezik _konstans elaszticitású_ modellnek is
...
- Hogyan lehet _analitikusan_ dönteni?
...
- ...és nézzük meg, hogy _együttesen_ szignifikánsak-e!
...
- A modellspecifikáció _általános_ tesztje; emiatt előnye: nem egy adott specifikációs kérdésre keres választ, hanem általában vizsgálja, hogy a specifikáció jó-e; hátránya, hogy ha nemleges választ ad, nem derül ki, hogy pontosan mi a specifikáció baja
