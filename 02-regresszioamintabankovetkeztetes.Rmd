...
$$\widehat{\mu}=\underset{m}{\mathrm{argmin}}\, \sum_{i=1}^n \left(y_i-\widehat{y_i}\right)^2=\underset{m}{\mathrm{argmin}}\, \sum_{i=1}^n \left(y_i-m\right)^2.$$
...
\begin{align*}
		&\left(\widehat{\beta_0},\widehat{\beta_1},\widehat{\beta_2},\ldots,\widehat{\beta_k}\right)=\underset{b_0,b_1,b_2,\ldots,b_k}{\mathrm{argmin}}\,\sum_{i=1}^n \left(y_i-\widehat{y_i}\right)^2=\\
		&=\underset{b_0,b_1,b_2,\ldots,b_k}{\mathrm{argmin}}\,\sum_{i=1}^n \left[y_i-\left(b_0 + b_1 x_{i1} + b_2 x_{i2} + \ldots + b_k x_{ik}\right)\right]^2
\end{align*}
...
$$\underline{Y}=\underline{\underline{X}} \pmb{\beta} + \pmb{\varepsilon}.$$
...
$$\underset{\mathbf{b}}{\mathrm{argmin}}\,\widehat{\mathbf{y}}^T \widehat{\mathbf{y}} = \underset{\mathbf{b}}{\mathrm{argmin}}\, \left(\mathbf{y}-\mathbf{X}\mathbf{b}\right)^T \left(\mathbf{y}-\mathbf{X}\mathbf{b}\right),$$
...
$$\underset{\mathbf{b}}{\mathrm{argmin}}\,\left(\mathbf{y}-\mathbf{X}\mathbf{b}\right)^T\left(\mathbf{y}-\mathbf{X}\mathbf{b}\right)=\underset{\mathbf{b}}{\mathrm{argmin}}\,\left[\mathbf{y}^T \mathbf{y}-2\mathbf{b}^T\mathbf{X}^T\mathbf{y}+\mathbf{b}^T\mathbf{X}^T\mathbf{X}\mathbf{b}\right].$$
